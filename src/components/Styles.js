...
export const obterEstilos = (dbConfig = {}) => {
    ...
    const styles = {
            ...
            carneTitle: { color: COLORS.primary, display: "block", marginBottom: "8px" },
            checkboxRow: { marginBottom: "4px" },
            checkboxRowCentered: {
                marginBottom: "6px",
                display: "flex",
                alignItems: "center",
            },
            labelPointer: { marginLeft: "5px", cursor: "pointer" },
            labelBold: { display: "block", marginBottom: "8px", fontWeight: "bold" },
            labelItem: { 
                marginLeft: "8px", 
                cursor: "pointer", 
                fontSize: "14px",
            ...
            modalTitleRed: { color: COLORS.primary, marginTop: 0 },
            infoBox: {
                fontSize: "14px",
                background: COLORS.grey10,
                padding: "10px",
            ...
            preLineText: {
                lineHeight: "1.6",
                color: COLORS.textMain,
                whiteSpace: "pre-line", // Preserva quebras de linha do Admin
                fontSize: "15px"
            },
            emptyMsg: {
                textAlign: 'center',
            ...
            cardBlue: { background: `${COLORS.blue}30`, borderColor: `${COLORS.blue}50` },
            cardGreen: { background: `${COLORS.green}30`, borderColor: `${COLORS.green}50` },
            cardValue: { margin: '0px', lineHeight: '1.2' },
            cardLabel: { fontSize: '12px', fontWeight: 'normal', color: COLORS.textMuted },
            filteredBadge: { fontSize: '10px', color: COLORS.primary },
            ...
            modalTitle: { margin: 0, fontSize: '16px', color: COLORS.grey75 },
            modalBody: { padding: '15px', overflowY: 'auto' },
            modalDate: { 
                fontSize: '13px', 
                color: COLORS.textMuted, 
                marginBottom: '10px' 
            ...
            textMain: { color: COLORS.grey75 },
            textQty: { color: COLORS.primary },
            tabContainer: {
                marginBottom: '20px'
            },
            adminWrapper: {
    ...
    const adminStyles = {
            ...
            // Estilos dinâmicos do Slider (base)
            sliderBase: {
                position: 'relative',
                display: 'inline-block',
                width: '120px',
    ...
    return {
        ...
        loginStyles: {
            ...
            erro: {
                backgroundColor: `${COLORS.danger}20`, // Cor de erro com 20% de opacidade (fica clarinho)
                color: COLORS.danger,
                borderColor: COLORS.danger
            },
            sucesso: {
                backgroundColor: `${COLORS.success}20`, // Cor de sucesso clarinha
            ...
            modal: { backgroundColor: '#fff', padding: '30px', borderRadius: '12px', width: '90%', maxWidth: '400px', boxShadow: '0 10px 25px rgba(0,0,0,0.2)' }
        },
